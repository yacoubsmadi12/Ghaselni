...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: LanguageSelectorWidget.routeName,
          path: LanguageSelectorWidget.routePath,
          builder: (context, params) => LanguageSelectorWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: OrderSummaryConfirmationWidget.routeName,
          path: OrderSummaryConfirmationWidget.routePath,
          builder: (context, params) => OrderSummaryConfirmationWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: OrdersHistoryWidget.routeName,
          path: OrdersHistoryWidget.routePath,
          builder: (context, params) => OrdersHistoryWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CaptainDashboardWidget.routeName,
          path: CaptainDashboardWidget.routePath,
          builder: (context, params) => CaptainDashboardWidget(),
        ),
        FFRoute(
          name: EarningsCaptainProfileWidget.routeName,
          path: EarningsCaptainProfileWidget.routePath,
          builder: (context, params) => EarningsCaptainProfileWidget(),
        ),
        FFRoute(
          name: PoliciesInfoWidget.routeName,
          path: PoliciesInfoWidget.routePath,
          builder: (context, params) => PoliciesInfoWidget(),
        )
