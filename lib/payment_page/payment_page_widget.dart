...
/// Payment page with two selectable options: Credit Card (fields for card
/// number, expiry date, CVV) and Cash on Delivery.
///
/// Each option has an icon and selection highlight. Primary “Pay Now” button.
...
class _PaymentPageWidgetState extends State<PaymentPageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldMask1 = MaskTextInputFormatter(mask: '0000 0000 0000 0000');
    _model.textController2 ??= TextEditingController();
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textFieldMask2 = MaskTextInputFormatter(mask: '00/00');
